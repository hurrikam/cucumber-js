...
function getColorFns(enabled) {
  if (enabled) {
    return {
      ...
      [_status.default.RETRIED]: _safe.default.yellow.bind(_safe.default),
      [_status.default.FLAKY]: _safe.default.yellow.bind(_safe.default),
    ...
    return {
      ...
      [_status.default.RETRIED]: _lodash.default.identity,
      [_status.default.FLAKY]: _lodash.default.identity,
