...
class SummaryFormatter extends _2.default {
  ...
  isTestCaseWarning(testCase) {
    return _lodash.default.includes([_status.default.FLAKY, _status.default.PENDING, _status.default.UNDEFINED], testCase.result.status) || testCase.attemptNumber > 1;
  }
