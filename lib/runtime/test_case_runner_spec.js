  ...
  (0, _mocha.describe)('run()', () => {
    ...
    (0, _mocha.describe)('with a flaky step and a positive retries value', () => {
      ...
      (0, _mocha.it)('emits test-step-started twice', function () {
        ...
        (0, _chai.expect)(this.onTestStepStarted.firstCall).to.have.been.calledWith(expectedTestStepStartedArgs);
        (0, _chai.expect)(this.onTestStepStarted.secondCall).to.have.been.calledWith(expectedTestStepStartedArgs);
      });
